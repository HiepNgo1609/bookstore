                ...
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    ...
                    <li class="nav-item mb-1">
                        ...
                        <div style="display:inline">
                            ...
                            <button onclick="search()" type="button" class="btn theme-btn btn-sm">Tìm
                                kiếm</button>
                        </div>
                        <!-- end Search nvar-->
                    </li>
                    <li class="nav-item"><a href="index.php" class="nav-link active"><i class="fa fa-home" aria-hidden="true"
                                style="scale:110%; color: white; padding-left:-2%">
                                <span> Trang chủ</span></i></a>
                    </li>
                    <li class="nav-item"> <a style="color: white" class="has-arrow nav-link active" href="category.php"
                            aria-expanded="false"><i class="fa fa-book" aria-hidden="true"></i><span class="hide-menu">
                                Thư viện sách</span></a></li>
                                <?php
                    if (empty($_SESSION['username'])) // if user is not login
                    {
                        ...
                        echo '<li class="nav-item dropdown" style="font-weight: 600; font-style: italic; margin-top: 6px">
